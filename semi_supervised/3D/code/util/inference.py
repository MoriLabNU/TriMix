...
def test_all_case_ensemble_ave(net1, net2, net3, image_list, num_classes, patch_size=(112, 112, 80), stride_xy=18,
    ...
    for image_path in tqdm(image_list):
        ...
        if preproc_fn is not None:
            image = preproc_fn(image)
        _, score_map1 = test_single_case(net1, image, stride_xy, stride_z, patch_size,
                                         num_classes=num_classes)
        _, score_map2 = test_single_case(net2, image, stride_xy, stride_z, patch_size,
                                         num_classes=num_classes)
        _, score_map3 = test_single_case(net3, image, stride_xy, stride_z, patch_size,
                                         num_classes=num_classes)
