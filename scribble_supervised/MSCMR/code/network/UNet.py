...
class Unet(nn.Module):
    ...
    def __init__(self, in_ch=1, out_ch=4):
        ...
        # we reduce the channel number here.
        # it can reduce memory cost and speed training and won't affect performance.
        ...
        self.Up_conv4 = conv_block(132, filters[3])

        self.Up3 = up_conv(filters[3], 4)
        self.Up_conv3 = conv_block(68, filters[2])
...
def build_UNet(args):
    return Unet(in_ch=1, out_ch=args.n_classes)
